...
const MenuLink = ({ icon, text, hasNewBadge, count }) => (
  <li className="group flex cursor-pointer items-center gap-2 text-gray-700 transition-colors duration-300 hover:text-orange-500">
    <div className="relative">
      <div className="relative text-3xl">{icon}</div>
      <div
        className={`absolute bottom-[0.5px] ${count > 9 ? "left-1 text-[12px]" : "left-1.5 text-sm"} z-10 font-bold`}
      >
        {count}
      </div>
    </div>
    ...
    {hasNewBadge && (
      <sup className="text-[10px] font-bold text-orange-500">NEW</sup>
    )}
  </li>
);
      ...
      <div className="container mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden cursor-pointer items-center gap-2 text-sm lg:flex">
              <span className="border-b-2 border-gray-800 text-gray-800">
                Other
              </span>
          ...
          <nav>
            <ul className="hidden items-center gap-8 text-base lg:flex">
              <MenuLink
                icon={icons.corporate}
                text="Swiggy Corporate"
                count={null}
              />
              <MenuLink icon={icons.search} text="Search" count={null} />
              <MenuLink
                icon={icons.offers}
                text="Offers"
                hasNewBadge
                count={null}
              />
              <MenuLink icon={icons.help} text="Help" count={null} />
              <MenuLink icon={icons.signIn} text="Sign In" count={null} />
              <NavLink to="/checkout">
                <MenuLink icon={icons.cart} text="Cart" count={count} />
              </NavLink>
            </ul>
          </nav>
        ...
        <div className="bg-white py-4 lg:hidden">
          <ul className="flex flex-col items-center gap-6 text-base">
            <MenuLink
              ...
              count={false}
            />
            <MenuLink icon={icons.search} text="Search" count={false} />
            <MenuLink
              icon={icons.offers}
              text="Offers"
              hasNewBadge
              count={false}
            />
            <MenuLink icon={icons.help} text="Help" count={false} />
            <MenuLink icon={icons.signIn} text="Sign In" count={false} />
            <NavLink to="/checkout">
              <MenuLink icon={icons.cart} text="Cart" count={count} />
            </NavLink>
          </ul>
